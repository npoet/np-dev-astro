...
Before this site and its scores domain were live, getting a bunch of sports results or live
scores on one page (without a wall of ads) was getting more difficult than it should be. My primary
interests here being american football and EPL soccer, I went searching for a better source of data.
...
dedicated to documenting this "hidden" API, and was a great starting point for the
CFBScores project. Since the 2021-2022 football season I've been building and using
CFBScores as a local tool to watch (and occasionally bet on) as many games as possible.
...
safely cache the scores data and refresh the cache every couple of hours when games aren't live.
