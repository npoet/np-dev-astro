...
import ScoreboardIslandFootball from '../../islands/ScoreboardIslandFootball.jsx';
...
<ScoreboardIslandFootball client:load />
...
While the gif file in the [GitHub](https://github.com/npoet/an-osrs-project) README is likely not up to
date at any given time, it is a decent representation of the type of swag we're working with here.
This account stays spooned.
